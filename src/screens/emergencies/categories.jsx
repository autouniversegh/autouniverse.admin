...
class Categories extends Component {
    ...
    getData = () => {
        ...
        func.get('emergencies-categories', { name: `%${iname}%`, limit: `${step},${limit}`, status: istatus }).then(res => {
    ...
    delete = (row) => {
        ...
        func.delte(`emergencies-categories/${row.uuid}`).then((res) => {
